   ...
   <div id="signupbox" style="margin-top:100px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
      <div class="panel panel-info">
         <div class="panel-body" >
            <form id="signupform" class="form-horizontal" role="form" action="<?php echo e(url('/queryMovie')); ?>" method="POST">
               <?php echo csrf_field(); ?>
               ...
               <div id="schedulebox" style="margin-top:100px" class="mainbox col-md-10 col-md-offset-1 col-sm-8 col-sm-offset-2">
                  <div class="table-responsive">
                     <table class="table table-hover">
                        ...
                        <a href="<?php echo e(url('').'/admin-panel/movies/insertMovie'); ?>">Add Movie Entries</a>
                        <tbody>
                           <tr>
                              <th>Movie Name</th>
                              <th>Genre</th>
                           ...
                           <tr>
                              ...
                              <td><?php echo e($movie->certificate); ?></td>
                              <td><a href="<?php echo e(url('/admin-panel/movies/edit/'.$movie->id)); ?>">edit</a></td>
                              <td><a href="<?php echo e(url('').'/admin-panel/movies/delete/'.$movie->id); ?>">delete</a></td>
                           </tr>
                           <?php endforeach; ?>
                        </tbody>
                     </table>
