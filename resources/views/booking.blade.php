        ...
        <div id="oginbox" style="margin-top:100px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
            <div class="panel panel-info" >
                    ...
                    <div style="padding-top:30px" class="panel-body" >
                        ...
                        <form id="loginform" class="form-horizontal" role="form" action="{{ url('/payment') }}" method="POST">
                            {!! csrf_field() !!}
							...
							<div style="margin-bottom: 25px" class="input-group">
								 ...
								 <div class="col-md-9">
                                 	<input type="text" class="form-control" name="movie" value="{{ $movie }}" disabled/>
								 </div>                                        
                            </div>
                                 ...
                                 <div class="col-md-9">
                                      <select class="form-control" id="sel1" name="time">
                                          @foreach($showTimes as $showTime)
                                               <option>{{ $showTime->showTime }}</option>
                                          @endforeach
                                      </select>
                                 </div>
                            </div>							
							...
							<div class="input-group">
								 <label class="radio-inline"><input type="radio" onClick="document.getElementById('ticketPrice').value={{ $hallprice['regular'] }};" name="optradio" value="regular">Regular class</label>
								 <label class="radio-inline"><input type="radio" onClick="document.getElementById('ticketPrice').value={{ $hallprice['premium'] }};" name="optradio" value="premium">Premium class</label>
							</div><!-- /input-group -->
							@if(count($errors) > 0)
								<ul>
